...
cmd = [
    ...
    "--add-data=ide/index.html:ide",
    "--add-data=ide/editor.js:ide",
    "--add-data=ide/style.css:ide",
    "--add-data=rijwal_idle.py:.",
    "--add-data=rijwal_games.py:.",
    "--add-data=docs/README.md:docs",
    "--add-data=docs/QUICK_START.md:docs",
    "--add-data=docs/LANGUAGE_REFERENCE.md:docs",
